...
CAR_SPECIFIC_CONFIGS = {
  ...
  CAR.HYUNDAI_IONIQ_6_2025: CarTuningConfig(
    vego_stopping=0.15,
    vego_starting=0.15,
    stopping_decel_rate=0.05,
    start_accel=1.6,
  ...
  CAR.HYUNDAI_SONATA_HYBRID: CarTuningConfig(
    ...
    start_accel=1.6,
    jerk_limits=(0.5, 4.0),
    brake_response=(1.2, 1.5, 1.95, 3.5),
    accel_limits=(-3.5, 2.0),
  ),
  ...
  CAR.HYUNDAI_SANTA_FE_PHEV_2022: CarTuningConfig(
    vego_stopping=0.25,
    vego_starting=0.15,
    stopping_decel_rate=0.012,
    start_accel=1.6,
    jerk_limits=(0.5, 5.0),
    brake_response=(1.5, 2.0, 2.8, 3.5),
    accel_limits=(-3.5, 2.0),
  ),
  ...
  CAR.KIA_K5_2025: CarTuningConfig(
    vego_stopping=0.25,
    vego_starting=0.15,
    stopping_decel_rate=0.012,
    start_accel=1.6,
...
def get_car_config(CP) -> CarTuningConfig:
