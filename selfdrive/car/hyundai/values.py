...
class CAR(Platforms):
  ...
  HYUNDAI_IONIQ_6_2025 = HyundaiCanFDPlatformConfig(
    [HyundaiCarDocs("Hyundai Ioniq 6 (with HDA II) 2025", "Highway Driving Assist II", car_parts=CarParts.common([CarHarness.hyundai_p]))],
    CarSpecs(mass=2084, wheelbase=2.97, steerRatio=14.26, tireStiffnessFactor=0.65),
    flags=HyundaiFlags.EV | HyundaiFlags.CANFD_NO_RADAR_DISABLE,
  )
  ...
  HYUNDAI_BAYON_1ST_GEN_NON_SCC = HyundaiPlatformConfig(
    ...
    flags=HyundaiFlagsCP.FP_NON_SCC | HyundaiFlagsCP.FP_NON_SCC_FCA | HyundaiFlags.CHECKSUM_CRC8,
  )
  ...
  HYUNDAI_KONA_NON_SCC = HyundaiPlatformConfig(
    ...
    HYUNDAI_KONA.specs,
    flags=HyundaiFlagsCP.FP_NON_SCC | HyundaiFlagsCP.FP_NON_SCC_FCA,
  )
  HYUNDAI_KONA_EV_NON_SCC = HyundaiPlatformConfig(
    ...
    HYUNDAI_KONA.specs,
    flags=HyundaiFlagsCP.FP_NON_SCC | HyundaiFlagsCP.FP_NON_SCC_FCA |HyundaiFlags.EV,
  )
  KIA_CEED_PHEV_2022_NON_SCC = HyundaiPlatformConfig(
    ...
    flags= HyundaiFlags.HYBRID | HyundaiFlagsCP.FP_NON_SCC | HyundaiFlagsCP.FP_NON_SCC_FCA,
  )
  KIA_FORTE_2019_NON_SCC = HyundaiPlatformConfig(
    ...
    KIA_FORTE.specs,
    flags=HyundaiFlagsCP.FP_NON_SCC,
  )
  ...
  GENESIS_G70_2021_NON_SCC = HyundaiPlatformConfig(
    ...
    flags=HyundaiFlagsCP.FP_NON_SCC | HyundaiFlagsCP.FP_NON_SCC_FCA | HyundaiFlagsCP.FP_NON_SCC_RADAR_FCA | HyundaiFlags.CHECKSUM_CRC8,
  )
...
NON_SCC_CAR = CAR.with_flags(HyundaiFlagsCP.FP_NON_SCC)
NON_SCC_FCA_CAR = CAR.with_flags(HyundaiFlagsCP.FP_NON_SCC_FCA)
