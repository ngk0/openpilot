...
from openpilot.selfdrive.car.hyundai.values import HyundaiFlags, HyundaiFlagsCP, CAR, DBC, CAN_GEARS, CAMERA_SCC_CAR, \
...
class CarState(CarStateBase):
  ...
  def update_canfd(self, cp, cp_cam, frogpilot_toggles):
    ...
    if self.CP.flags & HyundaiFlags.NAV_MSG or self.CP.flags & HyundaiFlags.LKAS12:
